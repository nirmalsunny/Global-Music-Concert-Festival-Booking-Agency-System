 ...
 * @author David
 */
public class ADeditCustomerAccounts extends javax.swing.JFrame {
    
   

    /**
     * Creates new customizer ADeditCustomerAccounts
     */
    public ADeditCustomerAccounts() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Customer's Accounts");
        ...
        jLabel3.setText("There are currently no users");
        jLabel1.setFont(new java.awt.Font("Segoe UI Light", 0, 12));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ADeditCustomerAccounts().setVisible(true);
        });
    }
}
