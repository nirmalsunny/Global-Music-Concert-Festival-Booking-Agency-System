 ...
 * @author Nirmal Sunny
 */
public class OrAddEvent extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrAddEvent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
